    ...
    public class GroundDetection : MonoBehaviour
    {
        ...
        public GroundEntity GetCurrentGroundEntity(WheelController wheelController)
        {
            if (wheelController.isGrounded && wheelController.wheelHit != null && wheelController.wheelHit.raycastHit.transform != null)
            {
                ...
                int dominantTerrainIndex = GetDominantTerrainTexture(hit.point);
        ...
        private float[] GetTerrainTextureComposition(Vector3 worldPos)
        {
            try
            {
        ...
        private int GetDominantTerrainTexture(Vector3 worldPos)
        {
            ...
            mix = GetTerrainTextureComposition(worldPos);
            if(mix != null)
            {
                float maxMix = 0;
                int maxIndex = 0;
